...
const packageName = "@hotflow/agent-os-kernel-contracts";
...
const outputPath = resolve(
  resultsDir,
  "director-phase-a-agent-os-kernel-contracts-gate-latest.json",
);
writeFileSync(
  outputPath,
  JSON.stringify(
    {
      summary: {
        suiteId: "director-phase-a-agent-os-kernel-contracts-gate",
...
process.stdout.write(
  `Director Agent OS kernel contracts gate completed: ${runs.length} checks, failed ${failedRuns.length}\n`,
);
