...
const steps = [
  {
    label: "agent-os-extensions-media-understanding-manifest-test",
    args: [
      "--filter",
      "@hotflow/agent-os-extensions",
      "exec",
      "vitest",
      "run",
      "--config",
      ...
      "-t",
      "media-understanding|first extension matrix",
    ],
  },
  {
  ...
  {
    label: "conversation-runtime-media-understanding-runner-test",
    args: [
      "--filter",
      ...
      "-t",
      "media-understanding|Agent OS extension manifests",
    ],
  },
  {
...
const outputPath = resolve(
  resultsDir,
  "director-phase-b3-agent-os-media-understanding-runner-gate-latest.json",
);
writeFileSync(
  outputPath,
  JSON.stringify(
    {
      summary: {
        suiteId: "director-phase-b3-agent-os-media-understanding-runner-gate",
...
process.stdout.write(
  `Director Agent OS media-understanding runner gate completed: ${runs.length} checks, failed ${failedRuns.length}\n`,
);
